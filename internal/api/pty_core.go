...
import (
	...
	"github.com/diffsec/agentmon/internal/pty"
...
func (a *App) startPTY(ctx context.Context, sessionID string, req ptyStartParams) (*ptyRun, int, error) {
	...
	pre := a.policyEngineFor(sess).CheckCommandWithExecveCtx(ctx, req.Command, req.Args, a.execveEnforcementActive(), a.shellCOpaqueMode())
