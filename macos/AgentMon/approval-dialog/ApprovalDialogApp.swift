...
/// Launched via URL scheme: agentmon-approval://approve?id=<requestID>
@main
struct ApprovalDialogApp: App {
    ...
    private func handleURL(_ url: URL) {
        ...
        // Expected format: agentmon-approval://approve?id=<requestID>
        guard let components = URLComponents(url: url, resolvingAgainstBaseURL: false),
            ...
            errorMessage = "Invalid URL format.\nExpected: agentmon-approval://approve?id=<requestID>"
            isLoading = false
    ...
    private func getLaunchURL() -> URL? {
        ...
        for arg in args where arg.hasPrefix("agentmon-approval://") {
