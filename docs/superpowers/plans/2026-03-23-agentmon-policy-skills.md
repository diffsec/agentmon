# AgentMon Policy Skills Implementation Plan

> **For agentic workers:** REQUIRED: Use superpowers:subagent-driven-development (if subagents available) or superpowers:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Create two skills (`policy-create` and `policy-edit`) with a shared schema reference for creating and editing AgentMon policy YAML files from any LLM environment.
...
**Tech Stack:** Markdown skill files, YAML policy format, `agentmon policy validate` CLI for validation.

**Spec:** `docs/superpowers/specs/2026-03-23-agentmon-policy-skills-design.md`
...
**Files:**
- Create: `skills/agentmon-policy-shared/schema-reference.md`
...
```bash
mkdir -p skills/agentmon-policy-shared
```
...
```bash
git add skills/agentmon-policy-shared/schema-reference.md
git commit -m "feat: add shared AgentMon policy schema reference"
```
...
**Files:**
- Create: `skills/agentmon-policy-create/SKILL.md`
- Reference: `configs/policies/default.yaml` (template style reference)
- Reference: `skills/agentmon-policy-shared/schema-reference.md`

- [ ] **Step 1: Create directory**

```bash
mkdir -p skills/agentmon-policy-create
```
...
```markdown
---
name: agentmon-policy-create
description: Use when creating a new AgentMon security policy, making a policy for an agent sandbox, CI pipeline, or development environment, or asking for a new policy YAML file
---

# Create AgentMon Policy
...
## Schema Reference
Read `skills/agentmon-policy-shared/schema-reference.md` for the complete policy YAML schema.
```
...
```bash
git add skills/agentmon-policy-create/SKILL.md
git commit -m "feat: add agentmon-policy-create skill"
```
...
**Files:**
- Create: `skills/agentmon-policy-edit/SKILL.md`
- Reference: `skills/agentmon-policy-shared/schema-reference.md`

- [ ] **Step 1: Create directory**

```bash
mkdir -p skills/agentmon-policy-edit
```
...
```markdown
---
name: agentmon-policy-edit
description: Use when adding, removing, or updating rules in an existing AgentMon policy, modifying security permissions, changing resource limits, or editing policy YAML files
---

# Edit AgentMon Policy
...
```bash
git add skills/agentmon-policy-edit/SKILL.md
git commit -m "feat: add agentmon-policy-edit skill"
```
...
**Files:**
- Read: `skills/agentmon-policy-create/SKILL.md`
- Read: `skills/agentmon-policy-edit/SKILL.md`
- Read: `skills/agentmon-policy-shared/schema-reference.md`
...
```bash
wc -w skills/agentmon-policy-create/SKILL.md
wc -w skills/agentmon-policy-edit/SKILL.md
wc -w skills/agentmon-policy-shared/schema-reference.md
```
...
Confirm both skills reference `skills/agentmon-policy-shared/schema-reference.md` correctly.
